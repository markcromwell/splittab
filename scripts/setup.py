'''
setup.py — Install SplitTab on a new machine.
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="SplitTab installer")
